...
pub fn json_arb_data2<
    K: std::marker::Send + for<'de> Deserialize<'de>,
    V: std::marker::Send + for<'de> Deserialize<'de>,
>() -> impl Filter<Extract = (Data2<K, V>,), Error = Rejection> + Clone {
